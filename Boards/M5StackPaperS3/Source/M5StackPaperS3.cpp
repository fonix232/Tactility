...
#define PAPERS3_TRANSACTION_SIZE (PAPERS3_EPD_HORIZONTAL_RESOLUTION * PAPERS3_EPD_VERTICAL_RESOLUTION * (LV_COLOR_DEPTH / 8))
...
extern const Configuration m5stack_papers3 = {
    .initBoot = initBoot,
    ...
    .spi {
        spi::Configuration {
            ...
            .config = {
                ...
                .max_transfer_sz = PAPERS3_TRANSACTION_SIZE,
                .flags = 0,
